...
import pl.oskarpolak.chat.models.repositories.LogRepository;
...
public class ChatSocket extends TextWebSocketHandler /* BinaryWebSocketHandler */ implements WebSocketConfigurer{
   ...
   @Autowired
    public ChatSocket(LogRepository logRepository) {   //wstrzykiwanie pół bezpośrednio bo w przyszłości nie będziemy mogli testowac komponentowo aplikacji
...
@Async     // Async działa tylko wtedy gdy metoda nie przyjmuje żadnych argumentów
